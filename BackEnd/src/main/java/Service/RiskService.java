...
public class RiskService {
  ...
  public static JsonObject calculerRisk(double revenu, double remboursement, int duree, double taux)
      throws IOException {
    ...
    RequestBody body =
        RequestBody.create(gson.toJson(jsonBody), MediaType.parse("application/json"));

    Request request = new Request.Builder().url(RISK_API_URL).post(body).build();
